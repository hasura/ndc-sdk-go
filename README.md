...
The SDK fully supports [NDC Specification v0.1.3](https://hasura.github.io/ndc-spec/specification/changelog.html#012) and [Connector Deployment spec](https://github.com/hasura/ndc-hub/blob/main/rfcs/0000-deployment.md) with following features:
