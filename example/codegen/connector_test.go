...
func createTestServer(
	...
	// reset global envs
	getGlobalEnvironments = sync.OnceValue(getGlobalEnvironmentsFunc)
	schemaResponse = sync.OnceValue(getSchemaResponseFunc)
	...
	testCases := []struct {
	...
	}{
		{
			...
			response: arguments.GetTypesArguments{
				...
				IntPtr:          new(11),
				Int8Ptr:         new(int8(12)),
				Int16Ptr:        new(int16(13)),
				Int32Ptr:        new(int32(14)),
				Int64Ptr:        new(int64(15)),
				UintPtr:         new(uint(16)),
				Uint8Ptr:        new(uint8(17)),
				Uint16Ptr:       new(uint16(18)),
				Uint32Ptr:       new(uint32(19)),
				Uint64Ptr:       new(uint64(20)),
				Float32Ptr:      new(float32(3.3)),
				Float64Ptr:      new(float64(4.4)),
				TimePtr:         new(time.Date(2024, 3, 5, 7, 0, 0, 0, time.UTC)),
				TextPtr:         new(types.Text("text pointer")),
				CustomScalarPtr: &commentTextPtr,
				EnumPtr:         new(types.SomeEnumBar),
				BigIntPtr:       new(scalar.BigInt(20000)),
				...
				ArrayUUIDPtr: []*uuid.UUID{
					new(uuid.MustParse("b085b0b9-007c-440e-9661-0d8f2de98a5c")),
					new(uuid.MustParse("b085b0b9-007c-440e-9661-0d8f2de98a5d")),
				},
				Map: map[string]any{
					"foo": "bar",
				},
				...
				JSONPtr:         new(any(map[string]any{"message": "json_ptr"})),
				RawJSON:         json.RawMessage(`{"message":"raw_json"}`),
				RawJSONPtr:      new(json.RawMessage(`{"message":"raw_json_ptr"}`)),
				...
				ArrayBoolPtr:    []*bool{new(true)},
				ArrayStringPtr:  []*string{new("foo")},
				ArrayIntPtr:     []*int{new(1)},
				ArrayInt8Ptr:    []*int8{new(int8(2))},
				ArrayInt16Ptr:   []*int16{new(int16(3))},
				ArrayInt32Ptr:   []*int32{new(int32(4))},
				ArrayInt64Ptr:   []*int64{new(int64(5))},
				ArrayUintPtr:    []*uint{new(uint(6))},
				ArrayUint8Ptr:   []*uint8{new(uint8(7))},
				ArrayUint16Ptr:  []*uint16{new(uint16(8))},
				ArrayUint32Ptr:  []*uint32{new(uint32(9))},
				ArrayUint64Ptr:  []*uint64{new(uint64(10))},
				ArrayFloat32Ptr: []*float32{new(float32(11.1))},
				ArrayFloat64Ptr: []*float64{new(float64(12.2))},
				ArrayBigInt:     []scalar.BigInt{scalar.BigInt(13)},
				ArrayBigIntPtr:  []*scalar.BigInt{new(scalar.BigInt(14))},
				ArrayJSON:       []any{map[string]any{"foo": "bar"}},
				ArrayJSONPtr:    []*any{new(any(map[string]any{"foo": "baz"}))},
				ArrayRawJSON:    []json.RawMessage{json.RawMessage(`{"message":"raw_json"}`)},
				ArrayRawJSONPtr: []*json.RawMessage{
					new(json.RawMessage(`{"message":"raw_json_ptr"}`)),
				},
				ArrayTime: []time.Time{time.Date(2024, 3, 5, 7, 0, 56, 0, time.UTC)},
				ArrayTimePtr: []*time.Time{
					new(time.Date(2024, 3, 5, 7, 0, 56, 0, time.UTC)),
				},
				...
				PtrArrayBoolPtr:    &[]*bool{new(true)},
				PtrArrayStringPtr:  &[]*string{new("foo")},
				PtrArrayIntPtr:     &[]*int{new(1)},
				PtrArrayInt8Ptr:    &[]*int8{new(int8(2))},
				PtrArrayInt16Ptr:   &[]*int16{new(int16(3))},
				PtrArrayInt32Ptr:   &[]*int32{new(int32(4))},
				PtrArrayInt64Ptr:   &[]*int64{new(int64(5))},
				PtrArrayUintPtr:    &[]*uint{new(uint(6))},
				PtrArrayUint8Ptr:   &[]*uint8{new(uint8(7))},
				PtrArrayUint16Ptr:  &[]*uint16{new(uint16(8))},
				PtrArrayUint32Ptr:  &[]*uint32{new(uint32(9))},
				PtrArrayUint64Ptr:  &[]*uint64{new(uint64(10))},
				PtrArrayFloat32Ptr: &[]*float32{new(float32(11.1))},
				PtrArrayFloat64Ptr: &[]*float64{new(float64(12.2))},
				PtrArrayBigInt:     &[]scalar.BigInt{scalar.BigInt(13)},
				PtrArrayBigIntPtr:  &[]*scalar.BigInt{new(scalar.BigInt(14))},
				PtrArrayJSON:       &[]any{map[string]any{"foo": "bar"}},
				PtrArrayJSONPtr:    &[]*any{new(any(map[string]any{"foo": "baz"}))},
