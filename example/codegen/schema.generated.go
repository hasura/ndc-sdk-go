...
func GetConnectorSchema() *schema.SchemaResponse {
	return &schema.SchemaResponse{
		...
		Functions: []schema.FunctionInfo{
			...
			{
				Name:        "getBool",
				Description: new("return an scalar boolean"),
			...
			{
				Name:        "getInts",
				Description: new("return a slice of scalar ints"),
			...
			{
				Name:        "hello",
				Description: new("sends a hello message"),
		...
		Procedures: []schema.ProcedureInfo{
			{
				Name:        "createAuthor",
				Description: new("creates an author"),
			...
			{
				Name:        "createAuthors",
				Description: new("creates a list of authors"),
