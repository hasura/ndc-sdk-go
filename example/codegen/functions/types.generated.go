...
var enumValues_FunctionName = []string{"getArticles", "getAuthor", "getAuthor2", "getBool", "getCustomHeaders", "getGenericWithoutDecodingMethod", "getInts", "getTypes", "hello"}
...
var enumValues_ProcedureName = []string{"createAuthor", "createAuthors", "create_article", "doCustomHeaders", "increase"}
